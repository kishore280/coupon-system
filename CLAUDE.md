...
- [docs/frappe-first-app-tutorial.md](docs/frappe-first-app-tutorial.md) — **start here to teach.**
  A whole **Frappe v16** app built around a deliberately tiny example (a library: books, members, loans),
  ...
  No ERPNext required.
- [docs/frappe-app-from-scratch.md](docs/frappe-app-from-scratch.md) — the same tour (also v16) against
  **this** app's core: DocType JSON, controllers, whitelisted API, hooks, desk JS, tests, cross-linked to the
